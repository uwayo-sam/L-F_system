...
<body>
    <div class="w-[100vw] h-[100vh] flex justify-between">
        ...
        <form action="../../backend/controllers/signin.php" method="post" class="w-[35vw] rounded-2xl ml-[130px] mt-[170px] flex px-9 flex-col gap-4 items-center border-2 border-gray-50 h-1/2 justify-center">
            <h1 class="text-3xl font-bold mb-4 text-white">Sign In</h1>
            ...
            <div class="flex flex-col gap-1 items-center">
                ...
                <p>if you don't have an acount <a href="signup" class=" underline text-gray-400 font-bold">sign up</a></p>
            </div>
           
        </form>
        <img src="../../public/image3.png" width="45%" height="100%" class="rounded-l-3xl shadow-sm shadow-gray-400" alt="">
    </div>
</body>
</html>