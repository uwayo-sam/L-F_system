...
<body>
    <!-- header -->
    <div class="w-[100vw] flex justify-between px-3 py-2">
        <div>
            <h1 class="text-2xl font-extrabold uppercase">L&F</h1>
        </div>
    ...
    <!-- main content -->
     ...
     <div class="mt-[5rem] flex flex-col gap-3 items-center  max-lg:mt-[30rem] max-lg:items-center">
        <div>
            ...
            <input type="text" name="search" placeholder="search here ..." class="w-[30vw] outline-none px-8 border-none caption-bottom">
        ...
        <div class="flex flex-col gap-4 items-center max-lg:w-[80%] w-[70%] mt-7">
         <h1 class="text-4xl font-extrabold max-lg:text-6xl">WELCOME TO LOST & FOUND HUB – YOUR LOST ITEM’S NEW HOPE!</h1>
          ...
          <p class="mt-4 max-lg:text-3xl max-lg:mt-10">Have you lost something important and want to find it? Or found something that 
